...
**Docker** hadir sebagai solusi berbasis *container* yang lebih ringan, cepat, dan banyak digunakan di dunia kerja. Buku panduan ini bertujuan menanamkan **mindset baru** kepada siswa bahwa membangun server tidak selalu harus menggunakan mesin virtual penuh, tetapi dapat dilakukan dengan container.

---

## 1. Overview tentang Docker
Docker adalah platform untuk menjalankan aplikasi di dalam *container*. Container berisi aplikasi beserta seluruh dependensinya, sehingga aplikasi dapat berjalan konsisten di berbagai lingkungan.
...
- Tambahkan Local DNS Record

#### Manajemen Hostname
- Menu *Local DNS > DNS Records*
